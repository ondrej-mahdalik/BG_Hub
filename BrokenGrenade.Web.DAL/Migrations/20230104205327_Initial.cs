        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SlottingSheetUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModpackUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LeaderBriefingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ConnectingToServerDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MissionStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    MissionTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModpackTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
