...
public static class MissionSeeds
{
    public static readonly MissionEntity Mission1 = new("Operace Divoký bažant",
        DateTime.Parse("01/05/2023 18:30", CultureInfo.InvariantCulture),
        DateTime.Parse("01/05/2023 19:00", CultureInfo.InvariantCulture))
    {
    ...
    public static readonly MissionEntity Mission2 = new("Den D",
        DateTime.Parse("03/24/2023 18:30", CultureInfo.InvariantCulture),
        DateTime.Parse("03/24/2023 19:00", CultureInfo.InvariantCulture))
    {
